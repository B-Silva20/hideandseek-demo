...
export default function Briefing({ briefing, onStart, error }: { briefing: CaseBriefing; onStart: () => void; error?: string }) {
  return <main className="briefing" aria-labelledby="briefing-title">
    ...
    <button className="refresh-button" type="button" onClick={onStart}>开始断案！</button>
  </main>
}
